...
if (!empty($_POST)) {
    ...
    if ($query_insert) {
        $alert = '<p class="alert alert-success">CREADO CORRECTAMENTE</p>';
    } else {
        echo $fecha;
    ...
    <section id="container">
        ...
        <div class="form_register">
            ...
            <form action="" method="POST">
                ...
                ?>
                <select name="pastel" id="pastel" multiple>
                    <?php
                ...
                <input type="text" name="nombres" id="nombres" placeholder="Nombres del  cliente " required autocomplete="off">
