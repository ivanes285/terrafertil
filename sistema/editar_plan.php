    ...
    <section id="container">
        <div class="form_register">
            ...
            <form action="" method="POST">
                ...
                <br />
                <br />
                <a style="border: 2px solid #36A152;  color: #ffffff; padding:10px 132px; background-color: #36A152; border-radius: 6px;" class="btn_save1" href="lista_planaccion.php?id=<?php echo $iddetalleclausula ?> &ida=<?php echo $iddetalleauditoria ?> ">Regresar</a>
