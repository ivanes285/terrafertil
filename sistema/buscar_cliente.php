...
<body>
	...
	<section id="container">
		...
		<a href="registro_cliente.php" class="btn_new">Ingresar Cliente</a>
    ...
    <th>Acciones</th>
		...
		<?php 
			...
			WHERE ( idcliente LIKE '%$busqueda%'
			 OR cedula LIKE '%$busqueda%' OR 
			 nombre LIKE '%$busqueda%' OR 					
			apellido LIKE '%$busqueda%' OR 
			telefono LIKE '%$busqueda%' OR 
			direccion LIKE '%$busqueda%' OR 
			correo  LIKE '%$busqueda%' OR 
			fechacumple LIKE '%$busqueda%') AND estatus = 1  ");
			...
			?>
				<tr>
					...
					<td><?php echo $data['fechacumple'] ?></td>
					<td>
